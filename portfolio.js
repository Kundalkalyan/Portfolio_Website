...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (btn) {
    ...
    if (savedTheme === "light") {
      // ONLY force light if user explicitly chose it
  ...
  // ── TYPEWRITER EFFECT ──
  const welcomeText =
    "Hi, I'm Kundal — building scalable web apps and exploring the frontiers of AI & Machine Learning.";
  ...
  console.log(
    "%c Hey there! 👋",
    "color: #6366f1; font-size: 1.2rem; font-weight: bold;",
  );
